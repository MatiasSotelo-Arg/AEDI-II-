...
int main() {
	...
	dato.codigo = 50;
	strcpy(dato.descripcion, "Descripcion 50");	
	insertarElemento(&arbol, dato);
	
	dato.codigo = 55;
	strcpy(dato.descripcion, "Descripcion 55");	
	insertarElemento(&arbol, dato);
	
	dato.codigo = 45;
	strcpy(dato.descripcion, "Descripcion 45");	
	insertarElemento(&arbol, dato);
	
	dato.codigo = 44;
	strcpy(dato.descripcion, "Descripcion 44");	
	insertarElemento(&arbol, dato);
